...
public static class ByteImagePngExtensions
{
    ...
    public static byte[] ToPng(this BaseImage<byte> image) => ToPng(image.ToWriteableBitmap());
    ...
    public static void ToPngFile(this BaseImage<byte> image, string fileName) => ToPngFile(image.ToWriteableBitmap(), fileName);

    public static BaseImage<byte> ByteImageFromPng(this byte[] data)
    {
